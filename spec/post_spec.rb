...
describe Post do
  ...
  context 'has_many through:' do
    ...
    let!(:post1) { Post.create! authors: [author1, author4] }
    let!(:post2) { Post.create! authors: [author1, author2] }
    let!(:post3) { Post.create! authors: [author4] }
    let!(:post4) { Post.create! authors: [author1, author2, author3] }
  ...
  context 'has_and_belongs_to_many' do
    ...
    let!(:post2) { Post.create! tags: [tag1, tag2] }
    let!(:post3) { Post.create! tags: [tag4] }
    let!(:post4) { Post.create! tags: [tag1, tag2, tag3] }
